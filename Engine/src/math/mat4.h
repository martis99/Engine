...
mat4 mat4_perspective0(float fovy, float aspect, float zNear, float zFar, int lhc);
mat4 mat4_perspective1(float fovy, float aspect, float zNear, float zFar, int lhc);
