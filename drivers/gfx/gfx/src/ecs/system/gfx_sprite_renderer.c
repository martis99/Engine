...
SpriteRenderer *sprite_renderer_create(SpriteRenderer *sprite_renderer, Renderer *renderer, Transform transform)
{
	...
	const char *src_frag = "vec2f tex_borders(vec2f tex_coord, vec2f tex_size, vec2f spr_size, vec4f spr_borders) {\n"
	...
	AValue vs_in[] = {
		{ VEC3F, "Position" }, { VEC4F, "Color" },   { VEC2F, "TexCoord" },   { VEC2F, "TexSize" },
		{ VEC1I, "TexId" },    { VEC2F, "SprSize" }, { VEC4F, "SprBorders" }, { VEC1I, "Entity" },
	};

	AValue vs_out[] = {
		{ VEC4F, "SV_Position" }, { VEC4F, "Color" },	{ VEC2F, "TexCoord" },	 { VEC2F, "TexSize" },
		{ VEC1I, "TexId" },	  { VEC2F, "SprSize" }, { VEC4F, "SprBorders" }, { VEC1I, "Entity" },
	};
