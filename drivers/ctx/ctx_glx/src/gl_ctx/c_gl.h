...
#define DECL_OPENGL_FUNC(returnType, name, ...)      \
	typedef returnType (*name##Fn)(__VA_ARGS__); \
	name##Fn name;
...
DECL_OPENGL_FUNC(GLuint, glGetDebugMessageLog, GLuint count, GLsizei bufSize, GLenum *sources, GLenum *types, GLuint *ids, GLenum *severities, GLsizei *lengths,
		 GLchar *messageLog)
...
DECL_OPENGL_FUNC(void, glGetIntegerv, GLenum pname, GLint *data);
DECL_OPENGL_FUNC(void, glClear, GLbitfield mask);
DECL_OPENGL_FUNC(void, glClearColor, GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
DECL_OPENGL_FUNC(void, glClearDepth, GLdouble depth);
DECL_OPENGL_FUNC(void, glDrawArrays, GLenum mode, GLint first, GLsizei count);
DECL_OPENGL_FUNC(void, glDrawElements, GLenum mode, GLsizei count, GLenum type, const GLvoid *indices);
DECL_OPENGL_FUNC(void, glPolygonMode, GLenum face, GLenum mode);
DECL_OPENGL_FUNC(void, glEnable, GLenum cap);
DECL_OPENGL_FUNC(void, glDisable, GLenum cap);
DECL_OPENGL_FUNC(void, glCullFace, GLenum mode);
DECL_OPENGL_FUNC(void, glFrontFace, GLenum mode);
DECL_OPENGL_FUNC(void, glGenTextures, GLsizei n, GLuint *textures);
DECL_OPENGL_FUNC(void, glBindTexture, GLenum target, GLuint texture);
DECL_OPENGL_FUNC(void, glTexImage2D, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type,
		 const GLvoid *data);
DECL_OPENGL_FUNC(void, glTexParameteri, GLenum target, GLenum pname, GLint param);
DECL_OPENGL_FUNC(void, glTexParameterf, GLenum target, GLenum pname, GLfloat param);
DECL_OPENGL_FUNC(void, glDeleteTextures, GLsizei n, const GLuint *textures);
DECL_OPENGL_FUNC(void, glBlendFunc, GLenum sfactor, GLenum dfactor);
DECL_OPENGL_FUNC(void, glDepthFunc, GLenum func);
DECL_OPENGL_FUNC(void, glPixelStorei, GLenum pname, GLint param);
DECL_OPENGL_FUNC(void, glBindTextureUnit, GLuint unit, GLuint texture);
DECL_OPENGL_FUNC(void, glViewport, GLint x, GLint y, GLsizei width, GLsizei height);
